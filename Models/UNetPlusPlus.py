...
class UNetPlusPlus(nn.Module):
    def __init__(self, n_classes=2, input_channels=3, deep_supervision=False):
        super().__init__()
        ...
        self.orient_head = nn.Conv2d(nb_filter[0], 37, kernel_size=1) # Adapting to 37 classes
    ...
    def forward(self, input):
        ...
        road = self.final(x0_4)
        orient = self.orient_head(x0_4)
